...
class RegistroLiquidacion extends Component
{
    ...
    public function render()
    {
       ...
       if(count($this->cantidad1)==0){
        ...
        return view('livewire.liquidaciones.registro-liquidacion');
    }
    ...
    public function store() {
        ...
        foreach ($this->reposiciones as $item) {
            ...
            if(!empty($this->valores[$i]['can']) && $this->valores[$i]['can'] < 0){
           ...
           //generar Un Cobro
            $cobro=Cobro::create([
             ...
             $acumtotal=0;
                ...
                $cobro->save();
            DB::commit();
            session()->flash('message', 'LIQUIDACION DE PROYECTO FINALIZADA EXITOSAMENTE');
